{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyP71Z1SAgpzaaGHDbQF8sjt",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/narenderkulariya/st20269341-CMP7005-PRAC1/blob/main/app_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "P3efG9vdoeJm",
        "outputId": "0b4e52ff-52cb-4ddd-cdba-b4b8e76e9323"
      },
      "execution_count": 49,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "O-fc9BQoohqr",
        "outputId": "79f03062-4275-4636-955e-a76b7ba56edf"
      },
      "execution_count": 50,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "QH53xNlnmzSm",
        "outputId": "14c7b5a8-9215-49e2-ba01-4a05a27b2b98"
      },
      "outputs": [
        {
          "output_type": "stream",
      ...
      "source": [
        ...
        "        st.error(\"⚠️ Error: 'all_cities_combined_cleaned.csv' not found. Please place it in the same directory.\")\n",
        "        return None\n",
        "\n",
        "df = load_data()\n",
        "\n",
        ...
        "page = st.sidebar.radio(\"Go to\", [\"🏠 Home & Data Overview\", \"📊 Exploratory Data Analysis (EDA)\", \"🤖 Modelling & Prediction\"])\n",
        "\n",
        "st.sidebar.markdown(\"---\")\n",
        ...
        "        tab1, tab2, tab3, tab4 = st.tabs([\"📈 Time Trends\", \"🌍 City Rankings\", \"🔥 Correlations\", \"📦 Categories\"])\n",
        "\n",
        "        with tab1:\n",
        ...
        "            st.info(\"💡 **Insight:** PM2.5 and PM10 show the highest positive correlation with AQI.\")\n",
        "\n",
        "        with tab4:\n",
        ...
        "\n",
        "        st.markdown(\"---\")\n",
        "        st.subheader(\"🎛️ Prediction Simulator\")\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "IrsVJ7-xos4N",
        "outputId": "0c388cd7-2189-400f-f47f-cee3b312600e"
      },
      "execution_count": 56,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "PwBMKf_PoxQY",
        "outputId": "22c9ebfc-9a90-4ef8-c58a-c732f59f9920"
      },
      "execution_count": 57,
      "outputs": [
        {
          ...
          "text": [
            ...
            "\u001b[0m\n",
            "\u001b[1G\u001b[0K⠸\u001b[1G\u001b[0K⠼\u001b[1G\u001b[0K⠴\u001b[1G\u001b[0K⠦\u001b[1G\u001b[0K⠧\u001b[1G\u001b[0K⠇\u001b[1G\u001b[0K⠏\u001b[1G\u001b[0K⠋\u001b[1G\u001b[0K⠙\u001b[1G\u001b[0K⠹\u001b[1G\u001b[0K⠸\u001b[1G\u001b[0K⠼\u001b[1G\u001b[0K⠴\u001b[1G\u001b[0K⠦\u001b[1G\u001b[0Kyour url is: https://hot-doors-arrive.loca.lt\n",
            "\u001b[0m\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "print(f\"Streamlit config written to {config_path}\")"
      ],
    ...
    },
    {
      ...
      "source": [
        ...
        "!pkill -9 localtunnel || true\n",
        "\n",
        "# Rerun the Streamlit app with localtunnel\n",
